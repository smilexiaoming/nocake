...
type User struct {
	...
	LastLoginTime string `gorm:"last_login_time"` // 最近一次登录时间
	...
	CreatedOn     string `gorm:"created_on"`      // 创建时间
	UpdatedOn     string `gorm:"updated_on"`      // 更新时间
	DeletedOn     string `gorm:"deleted_on"`      // 删除时间
}
