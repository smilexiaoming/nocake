...
CREATE TABLE `t_order` (
    `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
    `open_id` varchar(63) NOT NULL DEFAULT "" COMMENT '用户表的用户ID',
    `goods_ids`varchar(1023) NOT NULL DEFAULT "" COMMENT '货品id列表',
    `status` smallint(6) NOT NULL DEFAULT '1' COMMENT '订单状态 1 提交 2撤回 3已接单不可撤销 4已完成',
    `consignee` varchar(63) NULL COMMENT '收货人名称',
    `mobile` varchar(63) NULL COMMENT '收货人手机号',
    `address` varchar(1023) NULL COMMENT '收货具体地址',
    ...
    `dis_price` decimal(10, 2) NULL COMMENT '配送费用',
    `integral_price` decimal(10, 2) NULL COMMENT '用户积分减免',
    `groupon_price` decimal(10, 2) NULL COMMENT '团购优惠价减免',
    `order_price` decimal(10, 2) NULL COMMENT '订单费用， = goods_price + dis_price - coupon_price',
...
CREATE TABLE `t_address` (
    `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
    `name` varchar(63) NULL COMMENT '收货人名称',
    `open_id` varchar(63) NOT NULL DEFAULT "" COMMENT '用户表的用户ID',
    ...
    `detail` varchar(127) NULL COMMENT '详细收货地址',
